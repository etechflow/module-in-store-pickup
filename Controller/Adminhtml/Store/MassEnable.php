...
/**
 * Mass-enable selected stores from the listing.
 */
class MassEnable extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            foreach ($collection as $store) {
                if (!$store->isActive()) {
                    ...
                    try {
                        ...
                        $this->logger->error('ETechFlow_InStorePickup: mass-enable row failed.', [
            ...
            $this->messageManager->addSuccessMessage(__('%1 store(s) enabled.', $count));
        } catch (\Throwable $e) {
